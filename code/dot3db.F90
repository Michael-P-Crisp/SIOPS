...
!c-------------------------------------------------- 4 element corner -------
      ...
      dot4c = A(1)*Z(j0) + A(2)*Z(1+j0) + A(3)*Z(j1) + A(4)*Z(1+j1) + dotn( C, U )
...
!c-------------------------------------------------- 6 element side (hor) ---
      ...
      dot6h = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(2+j0) + A( 4)*Z(j1) + A( 5)*Z(1+j1) + A( 6)*Z(2+j1) + dotn( C, U )
...
!c-------------------------------------------------- 6 element side (vert) --
      ...
      dot6v = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(j1) + A( 4)*Z(1+j1) + A( 5)*Z(j2) + A( 6)*Z(1+j2) + dotn( C, U )
...
!c-------------------------------------------------- 9 element interior -----
      ...
      dot9i = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(2+j0) + A( 4)*Z(j1) + A( 5)*Z(1+j1) + A( 6)*Z(2+j1) + A( 7)*Z(j2) + A( 8)*Z(1+j2) + A( 9)*Z(2+j2) + dotn( C, U )
