...
!	1.2 Replaced common block variables across functions with subroutine arguments.
!		Updated syntax to Fortran 90 Standard
!c----------------------------------------------------------------------------
      subroutine dcvmt2( dvarfn, R, ir, B, ib, S, is, Dx, Dy, lformR , var, pb, H, G, da, db ,dthx,dthy)
      ...
      B(1,1) = dcvaa2(dvarfn,Dx,Dy,zero,zero, var, pb, H, G, da, db ,dthx,dthy)
      B(1,2) = dcvaa2(dvarfn,Dx,Dy,one,zero, var, pb, H, G, da, db ,dthx,dthy)
      B(1,3) = dcvaa2(dvarfn,Dx,Dy,zero,one, var, pb, H, G, da, db ,dthx,dthy)
      B(1,4) = dcvaa2(dvarfn,Dx,Dy,one,one, var, pb, H, G, da, db ,dthx,dthy)
      B(2,2) = B(1,1)
      B(2,3) = B(1,4)
      B(2,4) = B(1,3)
      B(3,3) = B(1,1)
      ...
      if( lformR ) then
         ...
         R(1,3) = dcvaa2(dvarfn,Dx,Dy,two,zero, var, pb, H, G, da, db ,dthx,dthy)
         R(4,6) = R(1,3)
         R(7,9) = R(1,3)
         ...
         R(1,6) = dcvaa2(dvarfn,Dx,Dy,two,one, var, pb, H, G, da, db ,dthx,dthy)
         R(4,9) = R(1,6)
         R(3,4) = R(1,6)
         R(6,7) = R(1,6)
         R(1,7) = dcvaa2(dvarfn,Dx,Dy,zero,two, var, pb, H, G, da, db ,dthx,dthy)
         R(2,8) = R(1,7)
         R(3,9) = R(1,7)
         R(1,8) = dcvaa2(dvarfn,Dx,Dy,one,two, var, pb, H, G, da, db ,dthx,dthy)
         R(2,9) = R(1,8)
         R(2,7) = R(1,8)
         R(3,8) = R(1,8)
         R(1,9) = dcvaa2(dvarfn,Dx,Dy,two,two, var, pb, H, G, da, db ,dthx,dthy)
         R(3,7) = R(1,9)
      endif

      S(1,1) = dcvab2(dvarfn,Dx,Dy, onept5, onept5 , var, pb, H, G, da, db ,dthx,dthy)
      S(2,1) = dcvab2(dvarfn,Dx,Dy, half,   onept5 , var, pb, H, G, da, db ,dthx,dthy)
      S(3,1) = dcvab2(dvarfn,Dx,Dy, twopt5, onept5 , var, pb, H, G, da, db ,dthx,dthy)
      S(4,1) = dcvab2(dvarfn,Dx,Dy, onept5, half   , var, pb, H, G, da, db ,dthx,dthy)
      S(5,1) = dcvab2(dvarfn,Dx,Dy, half,   half   , var, pb, H, G, da, db ,dthx,dthy)
      S(6,1) = dcvab2(dvarfn,Dx,Dy, twopt5, half   , var, pb, H, G, da, db ,dthx,dthy)
      S(7,1) = dcvab2(dvarfn,Dx,Dy, onept5, twopt5 , var, pb, H, G, da, db ,dthx,dthy)
      S(8,1) = dcvab2(dvarfn,Dx,Dy, half,   twopt5 , var, pb, H, G, da, db ,dthx,dthy)
      S(9,1) = dcvab2(dvarfn,Dx,Dy, twopt5, twopt5 , var, pb, H, G, da, db ,dthx,dthy)
      S(1,2) = S(3,1)
      S(2,2) = S(2,1)
      S(3,2) = S(1,1)
      S(4,2) = S(6,1)
