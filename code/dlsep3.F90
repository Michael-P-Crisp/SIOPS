...
!c  1.4	corrected references to dlsep2 and incorrect c below (Dec 8/11)
!c---------------------------------------------------------------------------
      real*8 function dlsep3( X, Y, Z, var, dpb, dthx, dthy, dthz,H,G,F)
      implicit real*8 (a-h,o-z)
      !common/dparam/ var, dpb, dthx, dthy, dthz
      real(8) var, dpb, dthx, dthy, dthz , H,G,F
