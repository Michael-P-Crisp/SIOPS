...
!c-------------------------------------------------- 8 element corner -------
      ...
      dot8c = A(1)*Z(j0) + A(2)*Z(1+j0) + A(3)*Z(j1) + A(4)*Z(1+j1) + A(5)*Z(j2) + A(6)*Z(1+j2) + A(7)*Z(j3) + A(8)*Z(1+j3)
!c    >      + dotn( C, U )
...
!c-------------------------------------- 12 element edge (horizontal) -------
      ...
      dot12h = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(2+j0) + A( 4)*Z(j1) + A( 5)*Z(1+j1) + A( 6)*Z(2+j1) + A( 7)*Z(j2) + A( 8)*Z(1+j2) + A( 9)*Z(2+j2) &
            + A(10)*Z(j3) + A(11)*Z(1+j3) + A(12)*Z(2+j3) + dotn( C, U )
...
!c-------------------------------------- 12 element edge (vertical) -------
      ...
      dot12v = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(j1) + A( 4)*Z(1+j1) + A( 5)*Z(j2) + A( 6)*Z(1+j2) + A( 7)*Z(j3) + A( 8)*Z(1+j3) &
            + A( 9)*Z(j4) + A(10)*Z(1+j4) + A(11)*Z(j5) + A(12)*Z(1+j5) + dotn( C, U )
...
!c-------------------------------------- 18 element side (front,back,top,bot) -
      ...
      dot18a = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(2+j0) + A( 4)*Z(j1) + A( 5)*Z(1+j1) + A( 6)*Z(2+j1) + A( 7)*Z(j2) + A( 8)*Z(1+j2) + A( 9)*Z(2+j2) &
            + A(10)*Z(j3) + A(11)*Z(1+j3) + A(12)*Z(2+j3) + A(13)*Z(j4) + A(14)*Z(1+j4) + A(15)*Z(2+j4) + A(16)*Z(j5) + A(17)*Z(1+j5) + A(18)*Z(2+j5) + dotn( C, U )
...
!c-------------------------------------- 18 element side (left and right) -
      ...
      dot18s = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(j1) + A( 4)*Z(1+j1) + A( 5)*Z(j2) + A( 6)*Z(1+j2) + A( 7)*Z(j3) + A( 8)*Z(1+j3) &
             + A( 9)*Z(j4) + A(10)*Z(1+j4) + A(11)*Z(j5) + A(12)*Z(1+j5) + A(13)*Z(j6) + A(14)*Z(1+j6) + A(15)*Z(j7) + A(16)*Z(1+j7) &
             + A(17)*Z(j8) + A(18)*Z(1+j8) + dotn( C, U )
...
!-------------------------------------- 27 element interior --------------
      ...
      dot27i = A( 1)*Z(j0) + A( 2)*Z(1+j0) + A( 3)*Z(2+j0) + A( 4)*Z(j1) + A( 5)*Z(1+j1) + A( 6)*Z(2+j1) + A( 7)*Z(j2) + A( 8)*Z(1+j2) + A( 9)*Z(2+j2) &
            + A(10)*Z(j3) + A(11)*Z(1+j3) + A(12)*Z(2+j3) + A(13)*Z(j4) + A(14)*Z(1+j4) + A(15)*Z(2+j4) + A(16)*Z(j5) + A(17)*Z(1+j5) + A(18)*Z(2+j5) &
            + A(19)*Z(j6) + A(20)*Z(1+j6) + A(21)*Z(2+j6) + A(22)*Z(j7) + A(23)*Z(1+j7) + A(24)*Z(2+j7) + A(25)*Z(j8) + A(26)*Z(1+j8) + A(27)*Z(2+j8) + dotn( C, U )
...
!c---------------------------------------------------------------------------
      ...
      dot6 = X(1)*Y(1) + X(2)*Y(2) + X(3)*Y(3) + X(4)*Y(4) + X(5)*Y(5) + X(6)*Y(6)
...
!c---------------------------------------------------------------------------
      ...
      dot7 = X(1)*Y(1) + X(2)*Y(2) + X(3)*Y(3) + X(4)*Y(4) + X(5)*Y(5) + X(6)*Y(6) + X(7)*Y(7)
