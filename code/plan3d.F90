...
!c  1.3	major corrections to element numbering below (Oct 9/11)
!c--------------------------------------------------------------------------
...
!c							1-D case
      ...
      if( (lk1.and.lk2) .or. (lk1.and.lk3) .or. (lk2.and.lk3) ) then
         ...
         Z(i0)   = AS(1,1,1)*Z(j0) + AS(2,1,1)*Z(j0+1) + CS(1,1)*U(1)
         Z(i0+1) = AS(1,2,1)*Z(j0) + AS(2,2,1)*Z(j0+1) + dot2(CS( 2,1),U(1))
         Z(i1)   = AS(1,3,1)*Z(j0) + AS(2,3,1)*Z(j0+1) + dot3(CS( 4,1),U(1))
         Z(i1+1) = AS(1,4,1)*Z(j0) + AS(2,4,1)*Z(j0+1) + dot4(CS( 7,1),U(1))
         Z(i2)   = AS(1,5,1)*Z(j0) + AS(2,5,1)*Z(j0+1) + dot5(CS(11,1),U(1))
         Z(i2+1) = AS(1,6,1)*Z(j0) + AS(2,6,1)*Z(j0+1) + dot6(CS(16,1),U(1))
         Z(i3)   = AS(1,7,1)*Z(j0) + AS(2,7,1)*Z(j0+1) + dot7(CS(22,1),U(1))
         ...
         do js = 1, jm-2
            ...
            i2 = i2 + iz
            i3 = i3 + iz
            Z(i0)   = AI(1,1)*Z(j0  )+AI(2,1)*Z(j0+1)+AI(3,1)*Z(j0+2) + CI(1)*U(L)
            Z(i0+1) = AI(1,2)*Z(j0  )+AI(2,2)*Z(j0+1)+AI(3,2)*Z(j0+2) + dot2(CI(2),U(L))
            Z(i1)   = AI(1,3)*Z(j0  )+AI(2,3)*Z(j0+1)+AI(3,3)*Z(j0+2) + dot3(CI(4),U(L))
            Z(i1+1) = AI(1,4)*Z(j0  )+AI(2,4)*Z(j0+1)+AI(3,4)*Z(j0+2) + dot4(CI(7),U(L))
            Z(i2)   = AI(1,5)*Z(j0  )+AI(2,5)*Z(j0+1)+AI(3,5)*Z(j0+2)  + dot5(CI(11),U(L))
            Z(i2+1) = AI(1,6)*Z(j0  )+AI(2,6)*Z(j0+1)+AI(3,6)*Z(j0+2) + dot6(CI(16),U(L))
            Z(i3)   = AI(1,7)*Z(j0  )+AI(2,7)*Z(j0+1)+AI(3,7)*Z(j0+2) + dot7(CI(22),U(L))
         ...
         i2 = i2 + iz
         i3 = i3 + iz
         Z(i0)   = AS(2,1,1)*Z(j0) + AS(1,1,1)*Z(j0+1) + CS(1,1)*U(1)
         Z(i0+1) = AS(2,2,1)*Z(j0) + AS(1,2,1)*Z(j0+1) + dot2(CS( 2,1),U(1))
         Z(i1)   = AS(2,3,1)*Z(j0) + AS(1,3,1)*Z(j0+1) + dot3(CS( 4,1),U(1))
         Z(i1+1) = AS(2,4,1)*Z(j0) + AS(1,4,1)*Z(j0+1) + dot4(CS( 7,1),U(1))
         Z(i2)   = AS(2,5,1)*Z(j0) + AS(1,5,1)*Z(j0+1) + dot5(CS(11,1),U(1))
         Z(i2+1) = AS(2,6,1)*Z(j0) + AS(1,6,1)*Z(j0+1) + dot6(CS(16,1),U(1))
         Z(i3)   = AS(2,7,1)*Z(j0) + AS(1,7,1)*Z(j0+1) + dot7(CS(22,1),U(1))
         Z(i3+1) = eight*Z(j0+1) - Z(i0) - Z(i0+1) - Z(i1) - Z(i1+1) - Z(i2) - Z(i2+1) - Z(i3)
         return
      endif
!c							2-D case
