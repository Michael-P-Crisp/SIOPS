...
!c---------------------------------------------------------------------------
      real*8 function dcvab3( cov, Dx, Dy, Dz, C1, C2, C3, var, pb, dthx, dthy, dthz ,H,G,F)
      parameter (NG = 20)
      implicit real*8 (a-h,o-z)
      dimension w(NG), z(NG)
      real(8) :: var, pb, dthx, dthy, dthz
      real(8) H,G,F
      ...
      if( (C1.lt.halfe).and.(C2.lt.halfe).and.(C3.lt.halfe) ) then
         ...
         do i = 1, NG
            ...
            do j = 1, NG
               ...
               do k = 1, NG
                  zk = Dz*(one + z(k))
                  d3 = d3 + w(k)*(one - z(k))*cov(xi,yj,zk,var,pb,dthx, dthy, dthz, H, G, F)
               end do
      ...
      do i = 1, NG
         ...
         do j = 1, NG
            ...
            do k = 1, NG
               ...
               dp = one + z(k)
               dm = one - z(k)
               d31 = d31 + w(k)*(dp*cov(x1,y1,z1,var, pb, dthx,       &
             dthy, dthz, H, G, F) + two*cov(x1,y1,z2,var, pb, dthx,  &
             dthy, dthz, H, G, F)                                     &
                               +dm*cov(x1,y1,z3,var, pb, dthx,        &
             dthy, dthz, H, G, F))
               d32 = d32 + w(k)*(dp*cov(x1,y2,z1,var, pb, dthx,        &
             dthy, dthz, H, G, F) + two*cov(x1,y2,z2,var, pb, dthx,  &
             dthy, dthz, H, G, F)                                     &
                               +dm*cov(x1,y2,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))
               d33 = d33 + w(k)*(dp*cov(x1,y3,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x1,y3,z2,var, pb, dthx,     &
             dthy, dthz, H, G, F)                                        &
                               +dm*cov(x1,y3,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))
               d34 = d34 + w(k)*(dp*cov(x2,y1,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x2,y1,z2,var, pb, dthx,     &
             dthy, dthz, H, G, F)                                       &
                               +dm*cov(x2,y1,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))
               d35 = d35 + w(k)*(dp*cov(x2,y2,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x2,y2,z2,var, pb, dthx,    &
             dthy, dthz, H, G, F)                                       &
                               +dm*cov(x2,y2,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))                                   
               d36 = d36 + w(k)*(dp*cov(x2,y3,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x2,y3,z2,var, pb, dthx,      &
             dthy, dthz, H, G, F)                                        &
                               +dm*cov(x2,y3,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))                                      
               d37 = d37 + w(k)*(dp*cov(x3,y1,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x3,y1,z2,var, pb, dthx,    &
             dthy, dthz, H, G, F)                                    &
                               +dm*cov(x3,y1,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))                                       
               d38 = d38 + w(k)*(dp*cov(x3,y2,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x3,y2,z2,var, pb, dthx,    &
             dthy, dthz, H, G, F)                                     &
                               +dm*cov(x3,y2,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))                                       
               d39 = d39 + w(k)*(dp*cov(x3,y3,z1,var, pb, dthx,         &
             dthy, dthz, H, G, F) + two*cov(x3,y3,z2,var, pb, dthx,    &
             dthy, dthz, H, G, F)                                        &
                               +dm*cov(x3,y3,z3,var, pb, dthx,         &
             dthy, dthz, H, G, F))
            end do
            dp = one + z(j)
            dm = one - z(j)
