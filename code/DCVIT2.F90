...
!c----------------------------------------------------------------------------
      subroutine dcvit2( dvarfn, Q, iq, R, ir, k1, k2, Dx, Dy , var, pb, H, G, da, db ,dthx,dthy)
      ...
      do j = 1, k2
         ...
         do i = 1, k1
            ii = ii + 1
            tx = dble(i-1)
            Q(1,ii) = dcvaa2( dvarfn, Dx, Dy, tx, ty , var, pb, H, G, da, db ,dthx,dthy)
		 end do
	  end do
      ...
      if( k1 .lt. 3 .or. k2 .lt. 3 ) then
         ...
         do j = 1, 3
            ...
            do i = 1, 3
               ii = ii + 1
               tx = dble(i-1)
               R(1,ii) = dcvaa2( dvarfn, Dx, Dy, tx, ty , var, pb, H, G, da, db ,dthx,dthy)
			end do
		 end do
