...
!c----------------------------------------------------------------------------
      subroutine dcvit3( dvarfn, R0, iq, R, ir, k1, k2, k3, Dx, Dy, Dz,var,pb,dthx,dthy,dthz,H,G,F)
      ...
      do k = 1, k3
         ...
         do j = 1, k2
            ...
            do i = 1, k1
               ii = ii + 1
               tx = dble(i-1)
               R0(1,ii) = dcvaa3(dvarfn,Dx,Dy,Dz,tx,ty,tz,var,pb,dthx,dthy,dthz, H, G, F)
              end do
          end do
      end do
         ...
         do k = 1, 3
            ...
            do j = 1, 3
               ...
               do i = 1, 3
                  tx = dble(i-1)
                  ii = ii + 1
                  R(1,ii) = dcvaa3(dvarfn,Dx,Dy,Dz,tx,ty,tz,var,pb,dthx,dthy,dthz, H, G, F)
               end do
            end do
         end do
